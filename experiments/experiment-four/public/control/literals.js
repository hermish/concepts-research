...
literals.instructionsOne = [
	...
	'On the following pages, you will see the topics and number of upvotes of 10 questions asked on a popular online ' +
	'forum. The upvotes were given by members of the online community who viewed the full questions, not just their ' +
	'topics. For each question, we will ask you to make a series of judgments. Please press the next button below or ' +
	'the arrow key to proceed.\n'
].join('\n');
...
literals.instructionsTwo = [
	...
	'On the next page, you will be asked select 5 topics of the 10 you have that presented with. If you could see ' +
	'the questions (and answers experts wrote), for five of these questions, which five would they be?\n',

	'Please select exactly *five* topics to see the questions for, otherwise the page will not let you submit. ' +
	'Please press the next button below or the arrow key to proceed.\n'
].join('\n')

literals.choosePage = [
	'### Your responses\n',

	'_Please remember to select exactly **five** topics you would like reveal the question and expert answers to._'
].join('\n');
